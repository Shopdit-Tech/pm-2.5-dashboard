    ...
    <div style={{ width: '100%', marginBottom: '20px' }}>
      ...
      <div
        style={{
          ...
          borderRadius: '16px',
          background:
            'linear-gradient(to right, #4299E1 0%, #4299E1 20%, #48BB78 20%, #48BB78 40%, #ECC94B 40%, #ECC94B 60%, #ED8936 60%, #ED8936 80%, #F56565 80%, #F56565 100%)',
          position: 'relative',
          overflow: 'visible',
  ...
  return (
    <div
      style={{
        position: 'relative',
        background:
          'linear-gradient(135deg, rgba(212, 241, 236, 0.95) 0%, rgba(230, 247, 245, 0.95) 100%)',
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: '18px', fontWeight: 700, color: '#1f2937' }}>{sensor.name}</div>
      </div>
      ...
      >
        ...
        อัพเดทล่าสุด:{' '}
        {new Date(sensor.timestamp).toLocaleString('th-TH', {
          year: 'numeric',
          month: 'short',
          day: 'numeric',
          hour: '2-digit',
      ...
      >
        <MetricCardWithBar label="PM1" value={sensor.pm1 || 0} unit="μg/m³" />
        <MetricCardWithBar label="PM 10" value={sensor.pm10} unit="μg/m³" />
        <MetricCardWithBar label="CO2" value={sensor.co2} unit="ppm" />
        <MetricCardWithBar label="TVOC" value={sensor.tvoc} unit="ppb" />
      </div>
    </div>
  );
};
